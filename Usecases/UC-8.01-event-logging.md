...
- [x] ID 1002: IIS binding refreshed (Information)
- [x] ID 1003: Certificate ordered (Information)
- [x] ID 1004: Certificate revoked (Information)
- [x] ID 1005: Force-renew with new key (Information)
...
- [x] ID 2001: IIS rebind / old-cert cleanup failed (Warning, operation continues)
...
- [x] ID 3004: Certificate revocation failed (Error)
- [x] ID 3005: Force-renew with new key failed (Error)
