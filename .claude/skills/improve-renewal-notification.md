...
- **Event log:** every mail send corresponds to an event log entry. Failure mail → event 3001. Success mail → event 1001. Test mail → event 1007. Update the registry in root `CLAUDE.md` if you add a new mail kind.
