---
name: plan-phase
description: Use when the user asks to plan a development phase ("plan Phase 2", "what's next for Phase 3"). Produces a scoped, traceable implementation plan from the phase's use cases before any code is written.
---

Plan one phase end-to-end before implementation starts. Stay in plan mode; do not write code.
