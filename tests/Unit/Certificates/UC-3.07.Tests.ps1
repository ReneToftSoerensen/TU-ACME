...
Describe 'UC-3.07 — Order surfaces Posh-ACME failure' -Tag 'Unit' {
    BeforeAll {
        ...
        $env:ProgramData = Join-Path ([System.IO.Path]::GetTempPath()) ("TU-ACME-uc307-" + [guid]::NewGuid().ToString('N'))
