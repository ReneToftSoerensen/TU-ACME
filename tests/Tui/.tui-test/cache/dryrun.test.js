//# hash=dfeb4577f36dc6a80d13bd4090adadea
...
test("shows the Dry-Run notice when started with -DryRun", function(param) {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    return [
                        4,
                        expect(terminal.getByText("Dry-Run mode: no changes will be made", {
                            strict: false
                        })).toBeVisible()
                    ];
                case 2:
